...
def parse_args(args=None):
    ...
    parser.add_argument("-o", "--obs-mode", type=str, default="rgb+segmentation", help="Observation mode to use. Usually this is kept as 'none' as observations are not necesary to be stored, they can be replayed later via the mani_skill.trajectory.replay_trajectory script.")
    ...
    parser.add_argument("--render-mode", type=str, default="sensors", help="can be 'sensors' or 'rgb_array' which only affect what is saved to videos")
