...
from gsworld.mani_skill.envs.tasks import StackFr3Env
...
def solve(env: StackFr3Env, seed=None, debug=False, vis=False, state_recover_file: str = None):
    env.reset(seed=seed)
    ...
    for i, obb in enumerate(obb_list):
        ...
        # Lift
        # -------------------------------------------------------------------------- #
        lift_pose = sapien.Pose([0, 0, 0.22]) * grasp_pose
