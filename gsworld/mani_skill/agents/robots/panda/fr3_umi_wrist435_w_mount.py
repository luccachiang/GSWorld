...
@register_agent()
class Fr3UmiWrist435CamMount(BaseAgent): # register and allow env.make
    uid = "fr3_umi_wrist435_cam_mount"
    urdf_path = f"{FILE_DIR}/mani_skill/assets/robots/panda/fr3_umi_wrist435_w_mount.urdf"
