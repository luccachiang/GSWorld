...
@register_agent()
class Fr3UmiWrist435(BaseAgent): # register and allow env.make
    uid = "fr3_umi_wrist435"
    urdf_path = f"{FILE_DIR}/mani_skill/assets/robots/panda/fr3_umi_wrist435.urdf"
